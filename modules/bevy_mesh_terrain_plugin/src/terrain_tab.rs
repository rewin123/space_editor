use bevy::prelude::*;
use bevy_mesh_terrain::{edit::TerrainCommandEvent, terrain::TerrainData, terrain_config::TerrainConfig};
...
impl Plugin for TerrainTabPlugin {
    fn build(&self, app: &mut App) {
        app.editor_tab_by_trait(EditorTabName::Other("Terrain".to_string()), TerrainTab::default());
    }
}
...
impl EditorTab for TerrainTab {
    fn ui(&mut self, ui: &mut bevy_inspector_egui::egui::Ui, commands: &mut Commands, world: &mut World) {
